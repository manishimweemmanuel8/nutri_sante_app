...
<head>
    ...
    <link type="text/css" href="{{asset('asset/admin/css/style.css')}}" rel="stylesheet" />
    <style>
        p {
            font-size:1.2rem;
        }
...
<div class="nav">
        <div class="row content">
            <img class="image" src="{{asset('asset/admin/img/IMG-20200304-WA0013.jpg')}}" alt="" /> 
        </div>
    </div>
    <div class="container">
    ...
    <div class="row content">
        <div class="right-side">
            <h1>Diet or Nutrition Counselling Prescribed/Recommended</h1>
            <p><b> a. Recommended</b> 
            <br><br> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                    et dolore magna aliqua. Ut enim ad minim veniam. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                    et dolore magna aliqua. Ut enim ad minim veniam. </p>

            <p><b>b. Restricted or Not Advised</b> 
            <br><br> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                    et dolore magna aliqua. Ut enim ad minim veniam. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                    et dolore magna aliqua. Ut enim ad minim veniam. </p>

            <p><b>c. Other advice</b>
            <br><br> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                    et dolore magna aliqua. Ut enim ad minim veniam. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                    et dolore magna aliqua. Ut enim ad minim veniam.</p>
