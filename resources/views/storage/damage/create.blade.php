                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12">
                                         <form id="add_users_form" method="post" action="{{route('damage.store')}}" class="form-horizontal">
                                            {{ csrf_field() }}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <select class="form-control" name="product_id" id="district">
                                                            ...
                                                            <option value="{{$stock->after_production_id}}">{{DB::table('products')->where('id',$stock->after_production_id)->value("name")}}</option>
