                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$rowProduct->supply_phone}}</td>
                                             ...
                                             <td>{{number_format($rowProduct->quantity + DB::table('preparations')->where('row_product_id',$rowProduct->id)->sum("quantity"))}} {{$rowProduct->category}}</td>
                                              <td>{{number_format($rowProduct->quantity)}} {{$rowProduct->category}}</td>
                                              <td>{{number_format(DB::table('preparations')->where('row_product_id',$rowProduct->id)->sum("quantity"))}} {{$rowProduct->category}}</td>
                                            ...
                                            <td>
                                                <a class=" btn btn-primary" href="{{route('rowProduct.edit',['id'=>$rowProduct->id])}}">
                                                    <i class="fa fa-fw fa-edit"></i> Edit
                                                </a>
                                            </td>
                                            <td>
                                                <a class=" btn btn-danger" href="{{route('rowProduct.destroy',['id'=>$rowProduct->id])}}" onclick="return confirmation()">
